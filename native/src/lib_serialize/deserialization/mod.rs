        ...
        C: Context<'v>,
    {
        ...
        for _ in 0..len {
            check_recursion! {
                ...
                map.set(cx, key, value).map_err(|_| "Failed to set property")?;
            }
        }
        ...
        C: Context<'v>,
    {
        ...
        for i in 0..len {
            check_recursion! {
                ...
                v.set(cx, index, value).map_err(|_| "Failed to set property")?;
            }
        }
        ...
        C: Context<'v>,
    {
        ...
        for i in 1..=array_len {
            check_recursion! {
                ...
                map.set(cx, index, value).map_err(|_| "Failed to set property")?;
            }
        }
